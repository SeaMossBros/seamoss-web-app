...
import { TextInput, Button, Group, FileInput, Image, Textarea } from '@mantine/core';
import './BlogForm.css';
        ...
        return (
            ...
            <div className='content-actions'>
                <div className='content-mover-arrows'>
                    <Button className='content-button' onClick={() => moveBlockUp(index)} disabled={index === 0}>↑</Button>
                    <Button className='content-button' onClick={() => moveBlockDown(index)} disabled={index === contentBlocks.length - 1}>↓</Button>
                </div>
                <Button className='content-button remove-text-field' c={'red'} color={'transparent'} onClick={() => handleRemoveBlock(index)}>X</Button>
            </div>
            </div>
        );
    };
    ...
    return (
        <div className='blogForm'>
            ...
            <Group mt="md" className='buttonGroup'>
                <Button c={'secondary-gray'} variant={'default'} onClick={handleAddSectionTitleBlock}>Add Section Title</Button>
                <Button c={'primary-green'} variant={'outline'} onClick={handleAddTextBlock}>Add Text Block</Button>
                <Button c={'secondary-blue'} variant={'subtle'} onClick={handleAddImageBlock}>Add Image Block</Button>
                {/* // TODO: Add tags */}
                <Button onClick={handleSubmit} className='submitButton'>Publish Article</Button>
            </Group>
        </div>
    );
};
