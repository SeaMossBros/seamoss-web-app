    ...
    >
      <Group display={'flex'} style={{ flexDirection: 'column' }}>
        ...
        {isNewUser && (
          <>
            <Text>
              We went ahead and created a profile for you with the email you used on stripe.
            </Text>
      ...
      <Group justify="flex-end" mt={15}>
        <Button
          variant="outline"
          component={Link}
          href={isNewUser ? ROUTE_PATHS.PROFILE.ORDERS : ROUTE_PATHS.LOGIN}
        >
          {isNewUser ? 'View Order on Profile' : 'Login to View Order on Profile'}
        </Button>
