  ...
  return (
    <div>
      ...
      <Container className={content} pt={54}>
        ...
        <Text fw={400}>
          This website is operated by SeaTheMoss. Throughout the site, the terms &ldquo;we&rdquo;,
          &ldquo;us&rdquo; and &ldquo;our&rdquo; refer to SeaTheMoss. SeaTheMoss offers this
          ...
          stated here. By visiting our site and/ or purchasing something from us, you engage in our
          &ldquo;Service&rdquo; and agree to be bound by the following terms and conditions
          (&ldquo;Terms of Service&rdquo;, &ldquo;Terms&rdquo;), including those additional terms
          and conditions and policies referenced herein and/or available by hyperlink. These Terms
          ...
          these Terms of Service carefully before accessing or using our website. By accessing or
          ...
          website or use any services. If these Terms of Service are considered an offer, acceptance
          is expressly limited to these Terms of Service. Any new features or tools which are added
          to the current store shall also be subject to the Terms of Service. You can review the
          most current version of the Terms of Service at any time on this page. We reserve the
          right to update, change or replace any part of these Terms of Service by posting updates
          and/or changes to our website. It is your responsibility to check this page periodically
          for changes. Your continued use of or access to the website following the posting of any
          changes constitutes acceptance of those changes. Our store is hosted on Shopify Inc. They
        ...
        <Text fw={400}>
          ...
          &ldquo;as is&rdquo; and &ldquo;as available&rdquo; without any warranties, representations
          or conditions of any kind and without any endorsement. We shall have no liability
          whatsoever arising from or relating to your use of optional third-party tools. Any use by
          you of optional tools offered through the site is entirely at your own risk and discretion
          and you should ensure that you are familiar with and approve of the terms on which tools
          are provided by the relevant third-party providers. We may also, in the future, offer new
        ...
        <Text fw={400}>
          ...
          origin, or disability; ( to submit false or misleading information; (g) to upload or
          ...
          others; (i) to spam, phish, pharm, pretext, spider, crawl, or scrape; lil for any obscene
        ...
        <Text fw={400}>
          ...
          all implied warranties or conditions of merchantability, merchantable quality, fitness for
          a particular purpose, durability, title, and non-infringement. In no case shall
          SeaTheMoss, our directors, officers, employees, affiliates, agents, contractors, interns,
        ...
        <Text fw={400}>
          You agree to indemnify, defend and hold harmless SeaTheMoss and our parent, subsidiaries,
